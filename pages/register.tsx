...
const Register = () => {
    ...
    const handlerRgister = async (event : FormEvent<HTMLFormElement>) => {
        ...
        if (password != confirmPassword) {
            ...
            settoastMessage("Senha ou confirmação não possuem de 6 a 20 digitos")
            ...
            <Container className='py-5'>
                ...
                <Form className={styles.form} onSubmit={handlerRgister}>
                    ...
                    <FormGroup>
                        ...
                        <Input id='birth' name='birth' type='date' min='1930-01-01' max='2023-12-31' required className={styles.input}/>
                    </FormGroup>
                    <FormGroup>
                        <Label for='password' className={styles.label}>SENHA</Label>
                        <Input id='password' name='password' type='password' placeholder='Digite a sua senha (Min: 6 | Max: 20)' required className={styles.input}/>
                    </FormGroup>
                    <FormGroup>
                        <Label for='confirmPassword' className={styles.label}>CONFIRME A SUA SENHA</Label>
                        <Input id='confirmPassword' name='confirmPassword' type='password' placeholder='Confirme a sua senha' required className={styles.input}/>
                    </FormGroup>
